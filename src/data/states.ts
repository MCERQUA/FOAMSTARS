// US States data for state landing pages and SEO
...
// Helper to find state by abbreviation
export const getStateByAbbreviation = (abbr: string): USState | undefined => {
  return US_STATES.find(s => s.abbreviation.toUpperCase() === abbr.toUpperCase())
}
